...
public final class InsGallery {
    ...
    public static void openGalleryImage(Activity activity, ImageEngine engine, OnResultCallbackListener listener) {
        openGallery(activity, engine, null, null, listener);
    }

    public static void openGalleryVideo(Activity activity, ImageEngine engine, OnResultCallbackListener listener) {
        openGalleryVideo(activity, engine, null, null, listener);
    }
    ...
    public static void openGalleryVideo(Activity activity, ImageEngine engine, CacheResourcesEngine cacheResourcesEngine, List<LocalMedia> selectionMedia, OnResultCallbackListener listener) {
